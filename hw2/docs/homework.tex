...
\begin{table}[h]
  ...
  \begin{table}[h]
    ...
    \begin{tabular}{c|c|c|c|c|c|c|c|c}
      ...
      $x_1$ & $A$   & $0$   & $1.2$ & $P$   & $0$                                    & $\frac{5}{9} \times \frac{2}{5} \times 0.4913$      & $P$             & $TP$     \\
      $x_2$ & $B$   & $1$   & $0.8$ & $P$   & $\frac{4}{9} \times \frac{1}{4} \times 1.339$      & $\frac{5}{9} \times \frac{1}{5} \times 1.749$      & $P$             & $TP$     \\
      $x_3$ & $A$   & $1$   & $0.5$ & $P$   & $\frac{4}{9} \times \frac{1}{4} \times 0.0155$      & $\frac{5}{9} \times \frac{1}{5} \times 0.564$      & $P$             & $TP$     \\
      $x_4$ & $A$   & $0$   & $0.9$ & $P$   & $0$                                    & $\frac{5}{9} \times \frac{2}{5} \times 1.714$      & $P$             & $TP$     \\
      $x_5$ & $B$   & $0$   & $1$   & $N$   & $\frac{4}{9} \times \frac{1}{2} \times 2.659$      & $\frac{5}{9} \times \frac{1}{5} \times 1.378$      & $N$             & $TN$     \\
      $x_6$ & $A$   & $0$   & $0.9$ & $N$   & $\frac{4}{9} \times \frac{1}{2} \times 2.3719$      & $\frac{5}{9} \times \frac{1}{5} \times 1.714$      & $N$             & $TN$     \\
      $x_7$ & $B$   & $1$   & $1.2$ & $N$   & $\frac{4}{9} \times \frac{1}{4} \times 0.848$       & $\frac{5}{9} \times \frac{1}{5} \times 0.4913$      & $N$             & $TN$     \\
      $x_8$ & $B$   & $1$   & $0.8$ & $N$   & $\frac{4}{9} \times \frac{1}{4} \times 1.339$      & $\frac{5}{9} \times \frac{1}{5} \times 1.749$      & $P$             & $FP$     \\
      $x_9$ & $B$   & $0$   & $0.8$ & $P$   & $\frac{4}{9} \times \frac{1}{2} \times 1.339$      & $\frac{5}{9} \times \frac{1}{5} \times 1.749$      & $P$             & $TP$    
    \end{tabular}%
    }
