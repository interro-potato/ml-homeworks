...
\begin{enumerate}[leftmargin=\labelsep]
  ...
  \item \textbf{Under a MAP assumption, compute $P(Positive | x)$ of each testing observation.}
        ...
        $$
        \begin{aligned}
          &\mu_{y_3, Positive} = 0.840 & \qquad & \mu_{y_3, Negative} = 0.975 & \qquad & \mu_{y_3} = 0.9000 \\
          &\sigma_{y_3, Positive}^2 = 0.063 & \qquad & \sigma_{y_3, Negative}^2 = 0.029 & \qquad & \sigma_{y_3}^2 = 0.0475
        \end{aligned}
        $$
