...
\begin{enumerate}[leftmargin=\labelsep,resume]
  ...
  \item \textbf{What is causing the non-determinism?}
        ...
        evaluated), even though the final centroids' positions were different - by calculating
        the norm of the difference between the final centroids' positions for each run,
        we were able to gather the following results:

        \begin{table}[H]
          \centering
          \begin{tabular}{c|c|c}
            Difference - seeds 0 and 1 & Difference - seeds 0 and 2 & Difference - seeds 1 and 2 \\ \hline
            3.1566                     & 4.4269                     & 3.3163
          \end{tabular}
          \caption{Norm of the difference between the final centroids' positions for each run}
          \label{tab:difference-norms}
        \end{table}
