  ...
  \item \textbf{Perform one epoch of the EM clustering algorithm and determine the new parameters.}
        ...
        \begin{itemize}[leftmargin=\labelsep]
          ...
          \item \textbf{M-step: Having calculated the posteriors, we can now
                ...
                \begin{equation*}
                  \begin{aligned}
                    \Sigma_1 & = \frac{\sum_{i=1}^3 P(C = k_1 \mid x_i) (x_{i, n} - \mu_{k_1, n}) (x_{i, m} - \mu_{k_1, m})^T}{\sum_{i=1}^3 P(C = k_1 \mid x_i)} \\
                ...
                \begin{equation*}
                  \begin{aligned}
                    \Sigma_2 & = \frac{\sum_{i=1}^3 P(C = k_2 \mid x_i) (x_{i, n} - \mu_{k_2, n}) (x_{i, m} - \mu_{k_2, m})^T}{\sum_{i=1}^3 P(C = k_2 \mid x_i)} \\
                    % TODO: "" 
